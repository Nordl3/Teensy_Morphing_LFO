...
// Potentiometer pins for rate control
const int POT_RATE_PIN = A5;

// Phase control potentiometer pins for each DAC output
const int POT_PHASE_PIN_DACA1 = A4; // Phase control for DACA1
const int POT_PHASE_PIN_DACA2 = A3; // Phase control for DACA2
const int POT_PHASE_PIN_DACB1 = A2; // Phase control for DACB1
const int POT_PHASE_PIN_DACB2 = A1; // Phase control for DACB2
...
// Write the interpolated value to DACA2
dacControl.writeDAC(1, 1, morphedValue_DACA2);
