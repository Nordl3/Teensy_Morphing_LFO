...
void loop() {
    ...
    int potPhaseValue_DACA1 = analogRead(POT_PHASE_PIN_DACA1); // Phase A
    int potPhaseValue_DACA2 = analogRead(POT_PHASE_PIN_DACA2); // Phase B
    int potPhaseValue_DACB1 = analogRead(POT_PHASE_PIN_DACB1); // Phase C
    int potPhaseValue_DACB2 = analogRead(POT_PHASE_PIN_DACB2); // Phase D

    int potMorphValue_DACA1 = analogRead(POT_MORPH_PIN_DACA1); // Morph A
    int potMorphValue_DACA2 = analogRead(POT_MORPH_PIN_DACA2); // Morph B
    int potMorphValue_DACB1 = analogRead(POT_MORPH_PIN_DACB1); // Morph C
    int potMorphValue_DACB2 = analogRead(POT_MORPH_PIN_DACB2); // Morph D

    // Print all values on the same line
    Serial.print("Rate: ");
    Serial.print(potRateValue);
    Serial.print(" | Phase A: ");
    Serial.print(potPhaseValue_DACA1);
    Serial.print(" | Phase B: ");
    Serial.print(potPhaseValue_DACA2);
    Serial.print(" | Phase C: ");
    Serial.print(potPhaseValue_DACB1);
    Serial.print(" | Phase D: ");
    Serial.print(potPhaseValue_DACB2);
    Serial.print(" | Morph A: ");
    Serial.print(potMorphValue_DACA1);
    Serial.print(" | Morph B: ");
    Serial.print(potMorphValue_DACA2);
    Serial.print(" | Morph C: ");
    Serial.print(potMorphValue_DACB1);
    Serial.print(" | Morph D: ");
    Serial.println(potMorphValue_DACB2); // End with a newline

    // Normalize the pot value to 0.0 to 1.0 for rate control
